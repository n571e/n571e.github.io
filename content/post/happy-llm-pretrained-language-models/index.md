...
description: "基于 Happy-LLM 第三章与我的 Wiki 笔记，系统梳理 Encoder-Only、Encoder-Decoder、Decoder-Only 三条路线，以及它们为何在大模型时代走向不同命运"
date: 2026-04-14
...
从 Transformer 的细节走到第三章，我最大的感受是：**预训练语言模型的分化，并不是“谁更先进”的简单竞争，而是“目标函数 + 信息流方式 + 工程可扩展性”的共同选择。**

这一章真正让我建立起一个更清楚的框架：同样都是 Transformer 家族，为什么 BERT 会成为 NLU 时代的王者，T5 会成为条件生成与任务统一的代表，而 GPT/LLaMA 最终又会在大模型时代完成收敛？本文基于我在 Wiki 中对 ch3 的整理，把这条主线重新讲一遍，并补上 tokenizer、embedding、causal mask 这些容易被忽略但实际非常关键的底层认知。
...
所以第三章真正的主线，不只是模型列表，而是：**不同结构如何围绕不同目标函数展开。**
...
<div align="center">
  ...
  <p>图 1. BERT 架构图，图片引自 Happy-LLM 第三章原文</p>
</div>
...
<div align="center">
  ...
  <p>图 2. T5 架构图，图片引自 Happy-LLM 第三章原文</p>
</div>
...
<div align="center">
  ...
  <p>图 3. GPT 架构图，图片引自 Happy-LLM 第三章原文</p>
</div>
...
<div align="center">
  ...
  <p>图 4. LLaMA 架构图，图片引自 Happy-LLM 第三章原文</p>
</div>
...
GLM 在这一章里特别有意思，因为它不是简单站队某一边，而是尝试把 **MLM 的双向理解能力** 和 **CLM 的自回归生成能力** 合在一起。
...
真正把第三章学明白，不只是记住 BERT、T5、GPT 这几个名字，而是能回答：
...
## 九、写在最后：第三章真正帮我建立的认知框架

如果说前两章让我知道了 Transformer 是怎么工作的，那么第三章真正让我明白的是：**模型架构的演化，本质上是在任务目标、信息流设计和工程现实之间不断做折中。**
